...
INSERT INTO posts (users_id, title, loc_barrio, loc_street, phone, description, status) VALUES (1, 'Chickpea Curry', 'Sant Marti', 'Sant Marti', '637 908 625', 'Yummy vegetarian curry with peppers and onions', default);
